...
int servohLimitHigh = 181;  //180
int servohLimitLow = 0;   //1

// 180 degrees MAX
Servo vertical;   // vertical servo 
int servov = 110;    //   110;     // stand vertical servo
...
void loop() { 
  ...
  int lt = (analogRead(ldrlt))+12; // top left
  int rt = (analogRead(ldrrt))-40; // top right
  int ld = (analogRead(ldrld))-10; // down left
  int rd = (analogRead(ldrrd))+39; // down rigt
